...
namespace BaiThucHanhBuoi1
{
    public partial class MainFom : Form
    {
        ...
        // click đôi vào nú chương trình sẽ tự động ạo hàm sự kiện này
        // khi ta click chuột vào nút chương tình sẽ làm gì
        ...
        // Ví dụ bên tên nhập gì bên dưỡi sao chép lại
